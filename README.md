...
\```dart
static String urlServe = 'http://192.168.1.6:8000';
\```

> ⚠️ Si estás probando en un emulador Android, usa `http://192.168.1.6:8000/api` en lugar de `192.168.1.6`, ya que el emulador no accede directamente al localhost de tu máquina.
